...
int main(int argc, char ** argv)
{
  ...
  std::vector<string> vector_of_topics({"lexus3/os_left/points", "lexus3/os_right/points", "lexus3/os_center/points", "empty", "empty", "empty", "empty"});
  // for(int i=1; i<argc-5; i++){
  //   string actual_topic_name(argv[i]);
  //   vector_of_topics[i-1] = actual_topic_name;
  // }
